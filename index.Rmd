...
central tendency, and density of ages within each category.

**Purpose**: This chart aims to show the distribution and density of
ages for each frequency of social media interaction category,
highlighting how age varies with social media usage patterns.

**Insights**: The violin plot reveals the age distribution within each
interaction frequency category. It helps identify which age groups are
